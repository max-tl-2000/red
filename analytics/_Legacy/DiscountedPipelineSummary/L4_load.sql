...
FROM "dstStarDB"."dstStarSchema"."d_Date" as d
	JOIN "dstNormDB"."dstNormSchema"."PartyStateHistory" as psh ON ((date(d."eventDt") = date(psh."end_date") ))
	JOIN "dstNormDB"."dstNormSchema"."PartyUserHistory" as puh ON (psh."analyticslogId"=puh."analyticslogId")
...
/* all parties of each state that entered the next state specifically on d_date.eventDt */
  FROM "dstStarDB"."dstStarSchema"."d_Date" as d
      JOIN "dstNormDB"."dstNormSchema"."PartyStateHistory" as psh ON ((date(d."eventDt") = date(psh."start_date") ))
      LEFT OUTER JOIN "dstNormDB"."dstNormSchema"."PartyUserHistory" as puh ON (psh."analyticslogId"=puh."analyticslogId")
      LEFT OUTER JOIN "dstStarDB"."dstStarSchema"."d_PipelineState" as ps ON (ps."state"=psh."state")
      JOIN (SELECT "partyId", MIN("propertyId"::text)::uuid AS "aPropertyId"
                FROM "dstNormDB"."dstNormSchema"."PartyTeam" pt, "dstNormDB"."dstNormSchema"."TeamProperties" tp
                WHERE pt."teamId"=tp."teamId"
...
SELECT DISTINCT
  ...
  FROM "dstStarDB"."dstStarSchema"."d_Date" as d
       JOIN "dstNormDB"."dstNormSchema"."PartyStateHistory" as psh ON "state"='Lease' AND date("end_date")=date(d."eventDt")
       LEFT OUTER JOIN "dstNormDB"."dstNormSchema"."PartyUserHistory" as puh ON (psh."analyticslogId"=puh."analyticslogId")
         JOIN (SELECT "partyId", MIN("propertyId"::text)::uuid AS "aPropertyId"
                FROM "dstNormDB"."dstNormSchema"."PartyTeam" pt, "dstNormDB"."dstNormSchema"."TeamProperties" tp
                WHERE pt."teamId"=tp."teamId"
...
SELECT DISTINCT
  ...
  FROM "dstStarDB"."dstStarSchema"."d_Date" as d
    ...
    (
      ...
      FROM "dstNormDB"."dstNormSchema"."PartyStateHistory"
    ...
    ON psh.start_date = t.max_time) as "partyStateHist" on
      ...
      LEFT OUTER JOIN "dstNormDB"."dstNormSchema"."PartyUserHistory" as puh ON ("partyStateHist"."analyticslogId"=puh."analyticslogId")
...
SELECT DISTINCT
  ...
  FROM "dstStarDB"."dstStarSchema"."d_Date" as d
  JOIN "dstNormDB"."dstNormSchema"."PartyStateHistory" as psh ON ( date(psh."start_date") <= date(d."eventDt"))
  LEFT OUTER JOIN "dstStarDB"."dstStarSchema"."d_PipelineState" as ps ON (ps."state"=psh."state")
  JOIN (SELECT "partyId", MIN("propertyId"::text)::uuid AS "aPropertyId"
                FROM "dstNormDB"."dstNormSchema"."PartyTeam" pt, "dstNormDB"."dstNormSchema"."TeamProperties" tp
                WHERE pt."teamId"=tp."teamId"
...
SELECT DISTINCT
  ...
  FROM "dstStarDB"."dstStarSchema"."d_Date" as d
  JOIN "dstNormDB"."dstNormSchema"."PartyStateHistory" as psh ON ( date(psh."start_date") <= date(d."eventDt") AND extract(month from psh."start_date")=extract(month from d."eventDt") AND extract(year from psh."start_date")=extract(year from d."eventDt"))
  LEFT OUTER JOIN "dstNormDB"."dstNormSchema"."PartyUserHistory" as puh ON (psh."analyticslogId"=puh."analyticslogId")
  LEFT OUTER JOIN "dstStarDB"."dstStarSchema"."d_PipelineState" as ps ON (ps."state"=psh."state")
  JOIN (SELECT "partyId", MIN("propertyId"::text)::uuid AS "aPropertyId"
                FROM "dstNormDB"."dstNormSchema"."PartyTeam" pt, "dstNormDB"."dstNormSchema"."TeamProperties" tp
...
SELECT DISTINCT
  ...
  FROM "dstStarDB"."dstStarSchema"."d_Date" as d
  JOIN "dstNormDB"."dstNormSchema"."PartyStateHistory" as psh ON ( date(psh."start_date") <= date(d."eventDt") AND (date(d."eventDt") <= date(psh."end_date") OR psh."end_date" IS NULL))
  LEFT OUTER JOIN "dstNormDB"."dstNormSchema"."PartyUserHistory" as puh ON (psh."analyticslogId"=puh."analyticslogId")
  LEFT OUTER JOIN "dstStarDB"."dstStarSchema"."d_PipelineState" as ps ON (ps."state"=psh."state")
  JOIN (SELECT "partyId", MIN("propertyId"::text)::uuid AS "aPropertyId"
                FROM "dstNormDB"."dstNormSchema"."PartyTeam" pt, "dstNormDB"."dstNormSchema"."TeamProperties" tp
