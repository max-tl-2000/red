...
JOIN "dstNormDB"."dstNormSchema"."n_TaskStateHistory" AS task ON 
...
FROM "dstStarDB"."dstStarSchema"."d_Date" AS d
JOIN "dstNormDB"."dstNormSchema"."n_TaskStateHistory" AS task ON date(d."eventDt") = date(task."end_date") 
JOIN (SELECT "partyId", MIN("propertyId"::TEXT)::uuid AS "aPropertyId"
	FROM "dstNormDB"."dstNormSchema"."n_PartyTeam" pt, "dstNormDB"."dstNormSchema"."n_TeamProperties" tp
	WHERE pt."teamId"=tp."teamId"
	GROUP BY "partyId") AS TeamProps ON TeamProps."partyId"=task."partyId"
