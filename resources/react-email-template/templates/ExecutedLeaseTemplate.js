...
const ExecutedLeaseTemplate = ({ tenantCommSettings, url, footerLinks, property, contactInfo, personInfo, inventory }) => {
      ...
      <div style={{ borderLeft: bodyMailBorder, borderRight: bodyMailBorder }}>
        ...
        <Card>
          ...
          <Text style={{ marginTop: '20px' }}>
            Congratulations! Your lease for {inventory.type} {inventory.name} at {property.displayName} has been successfully executed.
          </Text>
          <Button style={{ margin: '24px auto' }} width="auto" label="DOWNLOAD LEASE" href={url} />
...
export default ExecutedLeaseTemplate;
